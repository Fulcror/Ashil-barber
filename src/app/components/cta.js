  ...
  return (
    <div className="w-full py-12 px-6 space-y-6 bg-gray-50">
      ...
      <div className="bg-black w-full p-8 mt-8 text-center rounded-lg shadow-lg">
        ...
        <h2 className="text-4xl font-bold mb-3 text-white">Need a Haircut?</h2>
        <p className="text-lg mb-8 text-gray-300">
          Schedule your appointment today and experience premium grooming.
        </p>
        <a
          href="#book"
          className="py-3 px-8 bg-white text-black rounded-md hover:bg-gray-100 transition inline-block font-semibold text-lg shadow-md hover:shadow-lg"
        >
          Book Now
        </a>
      </div>
      ...
      <div className="bg-gray-100 w-full p-6 text-center rounded-lg border-2 border-gray-200">
        ...
        <h3 className="text-2xl font-semibold mb-2 text-black">Quick Chat</h3>
